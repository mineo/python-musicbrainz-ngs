...
class GetReleaseTest(unittest.TestCase):
    ...
    @unittest.skip("These tracks don't have artist credits in the XML")
    def testArtistCredit(self):
        ...
        tracks = res.release.medium_list.medium[0].track_list.track
        t1 = tracks
        self.assertEqual(t1.artist_credit, t1.recording.artist_credit)
        ...
        tracks = res.release.medium_list[0].track_list
        t1 = tracks[1]
        self.assertNotEqual(t1.artist_credit, t1.recording.artist_credit)
    ...
    def testTrackLength(self):
        ...
        tracks = res.release.medium_list.medium[0].track_list
    ...
    def testTrackNumber(self):
        ...
        tracks = res.release.medium_list[0]["data-track-list"]
    ...
    def testVideo(self):
        ...
        trackswithoutvideo = res.release.medium_list.medium[0].track_list
        trackswithvideo = res.release.medium_list.medium[2].track_list
        # TODO
    ...
    def testPregapTrack(self):
        ...
        medium = res.release.medium_list[0]
