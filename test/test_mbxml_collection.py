...
class GetCollectionTest(unittest.TestCase):
    ...
    def testCollectionReleases(self):
        ...
        self.assertEqual(coll.entity_type, "release")
        self.assertEqual(coll.type_, "Release")
        self.assertEqual(coll.release_list.count, 400)
    ...
    def testCollectionWorks(self):
        ...
        self.assertEqual(coll.entity_type, "work")
        self.assertEqual(coll.type_, "Work")
        self.assertEqual(coll.work_list.count, 1)
        self.assertEqual(len(coll.work_list.work), 1)
    ...
    def testCollectionArtists(self):
        ...
        self.assertEqual(coll.editor, "alastairp")
        self.assertEqual(coll.entity_type, "artist")
        self.assertEqual(coll.type_, "Artist")
        self.assertEqual(coll.artist_list.count, 1)
        self.assertEqual(len(coll.artist_list.artist), 1)
    ...
    def testCollectionEvents(self):
        ...
        self.assertEqual(coll.editor, "alastairp")
        self.assertEqual(coll.entity_type, "event")
        self.assertEqual(coll.type_, "Event")
        self.assertEqual(coll.event_list.count, 1)
        self.assertEqual(len(coll.event_list.event), 1)
    ...
    def testCollectionPlaces(self):
        ...
        self.assertEqual(coll.editor, "alastairp")
        self.assertEqual(coll.entity_type, "place")
        self.assertEqual(coll.type_, "Place")
        self.assertEqual(coll.place_list.count, 1)
        self.assertEqual(len(coll.place_list.place), 1)
    ...
    def testCollectionRecordings(self):
        ...
        self.assertEqual(coll.editor, "alastairp")
        self.assertEqual(coll.entity_type, "recording")
        self.assertEqual(coll.type_, "Recording")
        self.assertEqual(coll.recording_list.count, 1)
        self.assertEqual(len(coll.recording_list.recording), 1)
